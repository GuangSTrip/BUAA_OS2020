...
#define SYS_set_thread_status	((__SYSCALL_BASE ) + (16 ) )
#define SYS_getthreadid		((__SYSCALL_BASE ) + (17 ) )
...
#define SYS_sem_wait		((__SYSCALL_BASE ) + (22 ) )
#define SYS_sem_trywait		((__SYSCALL_BASE ) + (23 ) )
#define SYS_sem_post		((__SYSCALL_BASE ) + (24 ) )
#define SYS_sem_getvalue	((__SYSCALL_BASE ) + (25 ) )
#endif
